...
//                .addClasspathResource("processes/onboarding.bpmn20.xml")
                .addClasspathResource("processes/loan24h.bpmn20.xml")
                .deploy();
    ...
    public void initiateWorkflow(Employee employee, String processDefKey) {
        ...
        variables.put("sale_user", employee.getEmployee());
...
//        variables.put("nrOfHolidays", employee.getNrOfHolidays());
    ...
    public void completeUserTask(TaskInfo taskInfo) {
        Map<String, Object> variables = new HashMap<>();
        variables.put("sale_user", taskInfo.getAssignee());
        variables.put("action", taskInfo.getAction());
        variables.put("financal_user", taskInfo.getFinancalUser());
